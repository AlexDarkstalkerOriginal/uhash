...
function cbSearch(resp) { 
  ...
  $('.result').html('<h3>Result</h3><p class="time_res">Time of addition: <span></span></p><p class="mail_res">Owner\'s mail: <span></span></p><p class="wallet_res">Owner\'s wallet address: <span></span></p>');
